...
- [ ] Make a function to show an image of a certain class of the digit MNIST dataset and make a prediction on it. For example, plot 3 images of the `T-shirt` class with their predictions.
